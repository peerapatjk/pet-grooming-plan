    ...
    <div className="screen-content">
      ...
      <div className="card soft" style={{gap:14}}>
        ...
        <div className="dep-flow">
          <div className="node on">
            ...
            <div className="lbl">Hold today</div>
          </div>
          <div className="node">
      ...
      <div className="m-banner">
        ...
        <div>
          ...
          <p>The ฿200 hold is released the moment you check in. Free cancel until Mon 10:30. No‑show forfeits the hold.</p>
        </div>
      </div>
    </div>
    <div className="action-bar">
      <div className="cost"><div className="k">Hold today</div><div className="v">฿200</div></div>
...
function Screen09_Pay(){return(
  <div className="screen">
    <div className="screen-content">
      <div className="sc-head" style={{paddingTop:0}}>
        <div className="sc-ic"><ChevL/></div>
        <div><div className="eyebrow" style={{fontSize:9}}>Step 3 of 3</div><div style={{fontWeight:500,fontSize:14}}>Pay the hold</div></div>
        <div style={{width:36}}/>
      </div>
    ...
    <div className="action-bar">
      <div className="cost"><div className="k">Hold</div><div className="v">฿200</div></div>
      <button className="btn primary btn-lg">Confirm &amp; hold</button>
    </div>
  </div>
);}
    ...
    <div className="screen-content">
      ...
      <div className="card">
        <div className="kv">
          ...
          <div className="k"><span>Free cancel until</span><b>Mon 10:30</b></div>
        </div>
      </div>
      ...
      <div className="vtimeline">
        ...
        <div className="step cur"><b>Reminder 24h before</b><span>Mon 10:30</span></div>
    ...
    <div className="screen-content">
      ...
      <div className="card">
        <div className="kv">
          ...
          <div className="k"><span>Hold on card</span><b>Not yet · ฿150 pending</b></div>
        </div>
      </div>
      ...
      <div style={{display:'flex',flexDirection:'column',gap:10}}>
        <div className="shop-row" style={{borderColor:'var(--primary)',background:'var(--primary-wash)'}}>
          ...
          <div>
            ...
            <div className="meta"><span className="status s-instant" style={{padding:'2px 6px',fontSize:9}}>Instant</span><span>0.4 km · ★4.9</span></div>
        ...
        <div className="shop-row">
          ...
          <div>
            ...
            <div className="meta"><span className="status s-instant" style={{padding:'2px 6px',fontSize:9}}>Instant</span><span>1.2 km · ★4.8</span></div>
  ...
  <div className="screen">
    <div className="screen-content">
      ...
      <div className="card" style={{borderColor:'var(--primary)',gap:12}}>
        ...
        <div className="sub" style={{fontSize:12}}>Dash · Full groom · ฿200 hold · Due ฿500</div>
        <div style={{display:'flex',gap:8}}>
  ...
  <div className="screen dark">
    <div className="screen-content" style={{color:'var(--paper)'}}>
      ...
      <div style={{padding:16,background:'var(--primary)',borderRadius:14,display:'flex',flexDirection:'column',gap:8}}>
        ...
        <div className="row between" style={{opacity:.85,fontSize:12}}><span>Same groomer, same price</span><span>฿200 hold</span></div>
      </div>

    </div>
    <div className="action-bar" style={{background:'#14161c',borderColor:'rgba(255,255,255,.08)'}}>
